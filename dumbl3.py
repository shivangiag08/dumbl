...
def generate_workout_suggestion(prompt_input, relevant_exercises):
    ...
    output = replicate.run('a16z-infra/llama13b-v2-chat:df7690f1994d94e96ad9d568eac121aecf50684a0b0963b25a41cc40061269e5', input={"prompt": string_dialogue,"temperature":0.1, "top_p":0.9, "max_length":120, "repetition_penalty":1})
    return output
